...
- Uniform sentence length — if every sentence is 12-18 words, it reads like a machine
- Same starters in sequence — three paragraphs starting with "The..." or "This..."
- Summary sentence after every section — real writers don't recap constantly
- Triplet structures everywhere — "X, Y, and Z" as the default rhetorical move
- Smooth transitions between all sections — real writing has jumps, gaps, surprises
- "Not X, it's Y" framing as a repeated device
...
- Title Case For Every Subheading When Sentence Case Would Do
- Em dash overuse — one or two per piece is fine — but not every other sentence — like this
